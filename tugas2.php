...
<html lang="en">
    ...
    <div class="container px-5 my-5">
        ...
        if($status == 'Menikah' && $jlhAnak <= 2) $tunKel = 0.05 * $gapok;
        else if($status == 'Menikah' && $jlhAnak >= 3 && $jlhAnak <= 5) $tunKel = 0.1 * $gapok;
        else if($status == 'Menikah' && $jlhAnak > 5) $tunKel = 0.15 * $gapok;
        else $tunKel = 0;
